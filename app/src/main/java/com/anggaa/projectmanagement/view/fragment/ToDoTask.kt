...
class ToDoTask : Fragment() {
    ...
    override fun onCreateView(
        ...
        val dataList = arguments?.getParcelableArrayList<Task>(ToDoTask.ARG_DATA_LIST)
        val dataProject = arguments?.getParcelableArrayList<Project>(ToDoTask.ARG_DATA_PROJECT)
        val project = arguments?.getParcelable<Project>(ToDoTask.ARG_PROJECT)
