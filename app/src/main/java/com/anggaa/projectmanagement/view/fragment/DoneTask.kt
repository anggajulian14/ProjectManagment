...
class DoneTask : Fragment() {
    ...
    companion object {
        ...
        fun newInstance(ListProject : List<Project>, ListTask: List<Task>, project: Project): DoneTask {
            val fragment = DoneTask()
            val args = Bundle()
    ...
    override fun onCreateView(
        ...
        val project = arguments?.getParcelable<Project>(DoneTask.ARG_PROJECT)
