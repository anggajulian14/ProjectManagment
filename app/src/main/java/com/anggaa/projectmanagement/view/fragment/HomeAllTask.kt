...
class HomeAllTask : Fragment() {
    ...
    companion object {
        ...
        fun newInstance(ListTask: List<Task>, ListProject: List<Project>, project: Project): HomeAllTask {
            val fragment = HomeAllTask()
            val args = Bundle()
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_home_all_task, container, false)
